...
func NewRouter() *gin.Engine {
	...
	authorized.Use(middlewares.AuthMiddleware())
	{
		...
		authorized.POST("/cohort-stats/check-overlap/by-source-id/:sourceid/by-case-control-cohort-definition-ids/:casecohortid/:controlcohortid", cohortData.RetrieveCohortOverlapStatsWithoutFiltering)
